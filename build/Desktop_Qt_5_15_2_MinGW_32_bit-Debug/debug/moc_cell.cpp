...
QT_MOC_LITERAL(1, 5, 11), // "mouseButton"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 5), // "tecla"
QT_MOC_LITERAL(4, 24, 15), // "mousePressEvent"
QT_MOC_LITERAL(5, 40, 12) // "QMouseEvent*"

    },
    "Cell\0mouseButton\0\0tecla\0mousePressEvent\0"
    "QMouseEvent*"
};
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->mouseButton((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Cell::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::mouseButton)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Cell::mouseButton(QString _t1)
{
